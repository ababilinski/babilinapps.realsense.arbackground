// Please Read the RealSenseSDK for Licensing. 
//This shader is a copy of the ARBackground Shader from the RealSenseSDK2.0 Package.

Shader "Custom/URP/ARBackground"
{
	Properties
	{
		[NoScaleOffset]
